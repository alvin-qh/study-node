...
describe("test 'Array'", () => {
  ...
  it("should mapping 'Array'", () => {
    ...
    expect(a).toEqual([101, 102, 103, 104]);
    ...
    expect(a).toEqual([101, 102, 103, 104, 105, 106, 107, 108, 109]);
  });
  ...
  it("should insert elements into 'Array'", () => {
    ...
    expect(arr).toEqual([1, 2, 100, 200, 300, 3, 4, 5]);

    // 继续从数组下标 2 的位置删除 3 个元素, 并插入 2 个元素 (相当于替换)
    sp = arr.splice(2, 3, -1, -2);
    expect(sp).toEqual([100, 200, 300]);
    expect(arr).toEqual([1, 2, -1, -2, 3, 4, 5]);
  });
  ...
  it("should map and reduce elements from 'Array'", () => {
    ...
    expect(r).toEqual([101, 102, 103, 104, 105]);
...
describe("test 'Set'", () => {
  ...
  it("should use 'Set' collection", () => {
    ...
    expect(pairs).toEqual([[1, 1], [3, 3], [4, 4]]);
