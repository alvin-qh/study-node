...
`;
  ...
  it('should `render` element with attrs', () => {
    ...
    expect(html).toEqual('<a class="button" href="next-page.html">Click me</a>');
  });
...
<html>
  ...
  it('should `render` template file', () => {
    ...
    expect(elem?.textContent).toEqual('Pug Demo');

    elem = doc.querySelector('script');
    expect(elem?.getAttribute('src')).toEqual('jquery.js');
    ...
    expect(elems[0].getAttribute('data-name')).toEqual('Alvin');
    expect(elems[0].textContent).toEqual('34');
    expect(elems[1].getAttribute('data-name')).toEqual('Lily');
    expect(elems[1].textContent).toEqual('43');
    expect(elems[2].getAttribute('data-name')).toEqual('Pipy');
    expect(elems[2].textContent).toEqual('19');
  });
